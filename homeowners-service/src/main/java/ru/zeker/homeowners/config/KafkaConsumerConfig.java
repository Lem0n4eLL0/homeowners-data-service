package ru.zeker.homeowners.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "homeowners-service");
    ...
    @Bean("accrualKafkaListenerContainerFactory")
    ...
    smsKafkaListenerContainerFactory(
        ...
        return baseFactory(consumerFactory, executorService, errorHandler);
    }
