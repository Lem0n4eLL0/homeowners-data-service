...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "ru.zeker.common.dto.kafka.*");
    ...
    @Bean("smsKafkaListenerContainerFactory")
    public ConcurrentKafkaListenerContainerFactory<String, Object>
    smsKafkaListenerContainerFactory(
            ConsumerFactory<String, Object> consumerFactory,
            @Qualifier("virtualThreadTaskExecutor") AsyncTaskExecutor executorService,
            CommonErrorHandler errorHandler
    ) {
        return baseFactory(consumerFactory, executorService, errorHandler, 8);
    }

    @Bean("smtpKafkaListenerContainerFactory")
    public ConcurrentKafkaListenerContainerFactory<String, Object>
    smtpKafkaListenerContainerFactory(
            ConsumerFactory<String, Object> consumerFactory,
            @Qualifier("virtualThreadTaskExecutor") AsyncTaskExecutor executorService,
            CommonErrorHandler errorHandler
    ) {
        return baseFactory(consumerFactory, executorService, errorHandler, 2);
    }
    ...
    private ConcurrentKafkaListenerContainerFactory<String, Object> baseFactory(
            ConsumerFactory<String, Object> consumerFactory,
